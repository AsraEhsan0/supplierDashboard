...
namespace SupplierDashboard.Migrations
{
    ...
    [Migration("20250912222031_wallet Transactions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SupplierDashboard.Models.Entities.Agency", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(8567),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(8584),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(8588),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(8591),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(8593),
            ...
            modelBuilder.Entity("SupplierDashboard.Models.Entities.Agent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AgencyId = "kjf98932",
                            AgentName = "Yasir Ali",
                            CreatedAt = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(9206),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(9215),
                        ...
                        new
                        {
                            ...
                            AgencyId = "13asd4134",
                            AgentName = "Ali Khan",
                            CreatedAt = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(9219),
            ...
            modelBuilder.Entity("SupplierDashboard.Models.Entities.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "akdjf832",
                            AgentId = "akdjf;au332",
                            BookingDate = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(9334),
                            FlightNo = "FL001",
                            GroupName = "Group A",
                            PNR = "PNR12345",
                        ...
                        new
                        {
                            Id = "kja;iou29",
                            AgentId = "qiukdaj233",
                            BookingDate = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(9341),
                            FlightNo = "FL002",
                            GroupName = "Group B",
                            PNR = "PNR67890",
                        ...
                        new
                        {
                            Id = "akldja933",
                            AgentId = "akdjf;au332",
                            BookingDate = new DateTime(2025, 9, 12, 22, 20, 26, 533, DateTimeKind.Utc).AddTicks(9343),
                            FlightNo = "FL003",
                            GroupName = "Group C",
                            PNR = "PNR11122",
            ...
            modelBuilder.Entity("SupplierDashboard.Models.Entities.WalletSetting", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SupplierDashboard.Models.Entities.WalletTransaction", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SupplierDashboard.Models.Entities.WalletTransaction", b =>
                {
                    b.HasOne("SupplierDashboard.Models.Entities.SubAgency", "SubAgency")
